...
export const TRANSLATIONS: Record<'pt' | 'en', TranslationSet> = {
  pt: {
    ...
    heroDescription: "Há mais de 22 anos, o Nipon Spa une tradição japonesa, atendimento Omotenashi e protocolos personalizados para proporcionar uma experiência única de relaxamento e cuidado.",
  ...
  en: {
    ...
    heroDescription: "For over 22 years, Nipon Spa has combined Japanese tradition, Omotenashi hospitality, and personalized protocols to provide a unique relaxation and care experience.",
    btnBookNow: "Book Now",
