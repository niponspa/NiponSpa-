...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: 'volcanic-stones',
    titlePt: 'Maciço de Fuji: Os Benefícios Terapêuticos da Terapia de Pedras Vulcânicas Basálticas',
    titleEn: 'Fuji Massif: Therapeutic Benefits of Basaltic Volcanic Stones',
    excerptPt: 'Músculos tensos e fadiga crónica encontram descanso sob o calor profundo das nossas pedras vulcânicas de basalto importado.',
    excerptEn: 'Tense muscles and chronic fatigue find complete relief under the deep heat of our imported basaltic volcanic hot stones.',
    categoryPt: 'Terapêutica',
    categoryEn: 'Therapeutics',
    date: '2026-05-15',
    ...
    japaneseTitle: '玄武岩',
    contentPt: [
      'As pedras quentes têm sido utilizadas há milhares de anos para aliviar dores e restaurar a energia debilitada. No Japão, o calor profundo gerado pelas pedras quentes basálticas sempre serviu para equilibrar os canais meridianos por onde flui o "Ki" do paciente.',
      'Mas por que o basalto é tão eficaz?',
      'O basalto é uma rocha vulcânica densa e rica em minerais ferruginosos e magnésio, o que lhe confere uma capacidade física única de reter calor por longos períodos e libertá-lo em velocidades muito controladas na derme.',
      'Quando aplicamos as pedras aquecidas a 50°C em pontos energéticos cruciais das suas costas (como o meridiano da Bexiga):',
      '1. Vasodilatação Instantânea: O calor penetra nas camadas mais profundas das miofibras, expandindo vasos sanguíneos, aumentando o suprimento de oxigénio e drenando toxinas acumuladas pelo stress sedentário.',
      '2. Relaxamento do Sistema Nervoso: O peso térmico atua sobre os recetores táteis da pele, sinalizando ao cérebro para desativar o mecanismo de luta ou fuga simpático. O seu corpo entra de imediato numa onda de reequilíbrio parassimpático.',
      '3. Alívio de Espasmos: Fibromialgia, dores crónicas lombares e rigidez nos ombros dissolvem-se muito mais facilmente, permitindo que as massagens manuais subsequentes da Nipon sejam completamente indolores.',
      'Se vive no stress diário de computadores e prazos de Lisboa, reserve o tratamento de Pedras Vulcânicas Basáltica do Monte Fuji e sinta um calor restaurador que ressoa de volta ao seu centro interior.'
    ],
    contentEn: [
      'Hot stones have been used for thousands of years to soothe pain and reconstruct flagging energy. In Japan, the deep heat generated by hot basaltic stones has always served to balance meridian lines through which the patient’s "Ki" flows.',
      'But why is basalt so incredibly effective?',
      'Basalt is a dense volcanic rock rich in iron-bearing minerals and magnesium, which gives it a unique physical capacity to retain thermal energy for long periods and release it at very controlled levels into the skin layer.',
      'When we apply stones heated to 50°C to key energetic points along your back (such as the bladder meridian):',
      '1. Instant Vasodilation: The heat penetrates to the deep layers of the myofibers, expanding blood vessels, multiplying oxygen delivery, and flushing out accumulated sedimentary waste.',
      '2. Nervous Reset: The constant weighted warmth acts on the skin’s touch receptors, signaling your central nervous system to turn off its active sympathetic mode. Your bio-system shifts into a healing parasympathetic state.',
      '3. Spasm relief: Chronically tight lumber muscles, fibromyalgia pain, and collarbone knots soften much faster, making subsequent therapeutic physical strokes completely painless.',
      'If you live with the daily stress of keyboards and deadlines in Lisbon, schedule the Mount Fuji Hot Stone Therapy and feel a restorative warmth that echoes back to your quiet center.'
    ]
  }
];
